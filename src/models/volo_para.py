...
from timm.layers import trunc_normal_, DropPath, Mlp, create_conv2d, to_ntuple
...
class Outlooker(nn.Module):
    ...
    ################################################################# func start
        ...
        x = x + (self.para_scale * (self.parallel(shortcut).permute(0, 2, 3, 1).contiguous()))
    ################################################################# func end
        return x
